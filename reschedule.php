<?php 
   include "connect/db.php";
    ...
    if(isset($_GET["id"])){
      $id = $_GET["id"];
      $patient = $fun->fetchAppointmentsWithid($id);
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
          ...
          <form class="row g-3" action="form_submit.php" method="post" id="form" enctype="multipart/form-data">
            ...
            <input type="text" name="id" id="id" value="<?php echo $patient["app_id"] ?>" hidden>
            
            <div class="col-md-6">
              <label for="name" class="form-label">Patient Name</label>
              <input type="text" name="name" class="form-control" id="name" readonly value="<?php echo $patient["app_name"]?>">
            </div>
            <div class="col-md-6">
            ...
            <div class="text-center">
              ...
              <div class="" id="buttons">
                <button type="submit" name="change_date" class="btn btn-primary">Submit </button>
