      ...
      <div class="card">
        <div class="card-body">
          ...
          <?php
            ...
            else if (isset($_GET["msg"]) && $_GET["msg"] == "Enquiry Deleted Successfully") {
              ...
              if (mysqli_num_rows($enquiry) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($enquiry)) {
                  ...
                  echo "<tr>
                        ...
                        <td><a href='admit.php?id=$row[id]' class='btn btn-success'>Admitted</a> </td>
