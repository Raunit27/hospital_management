<?php 
  ...
  if(!isset($_SESSION["uname"])){
   ...
   $fetch=$fun->view_d_details($uname);
    ...
    // }
    $fetch = $fun->view_doctor_appointment_details($id);
  ?> 
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Patients <?php echo $id ?></h5>
                                ...
                                while($res = mysqli_fetch_assoc($fetch)){
                                    ?>
                                        <tr>
                                            ...
                                            <td class="">
                                                            <a href="update.php?status=true&id=<?php echo $res['patient_id'];?>"><button type="button"
