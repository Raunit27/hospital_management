...
<body>
    ...
    $msg="";
    $id=$_GET['id'];
    $fetch = $fun->view_full_doctor_details($id);
                                                ...
                                                <div class="card">
                                                    <div class="rounded-top text-white d-flex flex-row"
                                                        ...
                                                        <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                                            <img src="assets/img/doctor_img.jpg" alt="Generic placeholder image"
                                                    ...
                                                    <div class="card-body p-4 text-black">
                                                        <div class="mb-5">
                                                            ...
                                                            <div class="p-4" style="background-color: #f8f9fa;">
                                                                ...
                                                                <p class="font-italic mb-3">Specialty : <?php echo $res['specialty'];?></p>
                                                                <p class="font-italic mb-3">Date of birth : <?php echo $res['dob'];?></p>
                                                                <p class="font-italic mb-3">Date of Joining : <?php echo $res['doj'];?></p>
                                                                <p class="font-italic mb-3">Qualification : <?php echo $res['qualification'];?></p>
                                                                <p class="font-italic mb-3">Experience : <?php echo $res['experience'];?> years</p>
                                                            </div>
                                                        </div>
                                                        <!-- <div
